...
uv run python -m bizintel.app_addie
...
def main() -> None:
    ...
    plot_bar(
        ...
        x="Region",
        y="SaleAmount",
        title="Smart Sales Revenue by Customer Region",
        xlabel="Region",
    ...
    LOG.info("Identifying the three highest-revenue product categories........")
    df_top_categories = df_category.head(3)

    LOG.info("CALL a function to plot the top three product categories........")
    plot_bar(
        df=df_top_categories,
        x="Category",
        y="SaleAmount",
        title="Top 3 Product Categories by Sales Revenue",
        xlabel="Product Category",
        ylabel="Total Sales Revenue ($)",
        palette="Oranges_d",
    )
